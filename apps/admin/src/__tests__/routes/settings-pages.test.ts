...
vi.mock('$lib/api', () => ({
  api: {
    ...
    getPrayerRulesPreview: vi.fn().mockResolvedValue({ date: '2026-08-05', hijri: { month: 11, day: 22, year: 1447 }, sunrise: '05:45', chains: {} }),
    getHijriToday: vi.fn().mockResolvedValue({ month: 11, day: 22, year: 1447 }),
    createPrayerRule: vi.fn().mockResolvedValue({ id: 'r1' }),
    updatePrayerRule: vi.fn().mockResolvedValue({ success: true }),
