...
export const StyleOptionsSchema = z
  .object({
    ...
    whatsappGroupUrl: z.string().trim().max(2000).optional(),
    donateReasons: z
      .array(
        z.object({
...
export const CreateMasjidSchema = z.object({
  ...
  adjust_sunrise: z.number().int().default(0),
  adjust_dhuhr: z.number().int().default(0),
  adjust_asr: z.number().int().default(0),
  adjust_maghrib: z.number().int().default(0),
  adjust_isha: z.number().int().default(0),
...
export const MasjidProfileSchema = z.object({
  ...
  adjust_sunrise: z.number().int(),
  adjust_dhuhr: z.number().int(),
  adjust_asr: z.number().int(),
  adjust_maghrib: z.number().int(),
  adjust_isha: z.number().int(),
